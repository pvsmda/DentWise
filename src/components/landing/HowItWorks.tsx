    ...
    <section className="relative py-32 px-6 outline-hidden z-10 max-w-7xl mx-auto">
      ...
      <div className="text-center mb-20">
        ...
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
          Nosso processo simplificado torna o atendimento odontológico
          acessível, conveniente e sem estresse para todos
        </p>
      </div>
        ...
        <div className="grid lg:grid-cols-3 gap-12 lg:gap-8">
          ...
          <div className="relative group">
            <div className="relative bg-gradient-to-br from-card/80 to-card/40 backdrop-blur-xl rounded-3xl p-8 border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10">
              ...
              <p className="text-muted-foreground text-center leading-relaxed mb-6">
                Converse com nosso assistente de IA sobre quaisquer problemas
                odontológicos. Obter respostas instantâneas sobre sintomas,
                tratamentos, saúde bucal e dicas.
              </p>
          ...
          <div className="relative group">
            <div className="relative bg-gradient-to-br from-card/80 to-card/40 backdrop-blur-xl rounded-3xl p-8 border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10">
              ...
              <p className="text-muted-foreground text-center leading-relaxed mb-6">
                Receba recomendações personalizadas com base em milhares de
                casos odontológicos. Nossa IA fornece insights de nível
                profissional.
              </p>
          ...
          <div className="relative group">
            <div className="relative bg-gradient-to-br from-card/80 to-card/40 backdrop-blur-xl rounded-3xl p-8 border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10">
              ...
              <h3 className="text-2xl font-bold mb-4 text-center">
                Reserve e obtenha cuidados
              </h3>
              <p className="text-muted-foreground text-center leading-relaxed mb-6">
                Agende com dentistas verificados e receba informações
                abrangentes cuidados de acompanhamento. Acompanhe seu progresso
                sem problemas.
              </p>
