            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Acesse o Plano Pro e desbloqueie toda a potência da IA para
                  melhorar a qualidade dos seus atendimentos odontológicos.
                </p>
              </div>
            </div>
        ...
        <div className="space-y-8">
          <div className="text-center space-y-4">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Escolha o plano que melhor se adequa ao seu budget e a sua
