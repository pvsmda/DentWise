          ...
          <div className="space-y-4">
            ...
            <div>
              <h1 className="text-4xl font-bold mb-2">
                Bem vindo de volta, {user?.firstName || "Admin"}!
              </h1>
              <p className="text-muted-foreground">
                Gerencie sua equipe de dentistas, organize os agendamentos e
                acompanhe de perto a performance da sua clínica odontológica.
              </p>
            </div>
          </div>
